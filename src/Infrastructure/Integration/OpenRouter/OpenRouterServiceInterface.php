...
interface OpenRouterServiceInterface
{
     ...
     * @param array<string, mixed> $options Optional parameters to override defaults
     *
     * @return \App\Infrastructure\Integration\OpenRouter\DTO\FlashcardGenerationResult
     *
     * @throws OpenRouterException If generation fails
     * @throws \InvalidArgumentException If source text length is invalid
     */
    public function generateFlashcardsWithMetadata(string $sourceText, array $options = []): \App\Infrastructure\Integration\OpenRouter\DTO\FlashcardGenerationResult;
